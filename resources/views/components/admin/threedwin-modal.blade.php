            ...
            <div class="p-6">
                ...
                <div class="flex flex-wrap -mx-2">
                    <div class="w-full mb-4">
                        <x-admin.label for="threedNumber" label="3d နံပါတ်" required="true" />
                        <x-admin.inputs.input id="threedNumber" label="threedNumber" type="number" wire:model="threedNumber"
