<div>
    <x-admin.pages-header title="3D ဂဏန်းအချုပ်" :breadcrumbs="[['label' => '3D လယ်ဂျာ', 'url' => route('admin.threed-ledger')], ['label' => 'List']]" :permission="Gate::check('two_d_ledger_create_false')" :route="route('admin.threed-ledger', ['action' => 'create'])" />
    ...
    <div class="rounded-lg shadow-lg bg-primary-500">
        ...
        <x-admin.table>
            ...
            <!-- Body Slot -->
            <x-slot name="body">
                @forelse($threedledgerNumberBalances as $index => $ledger)
