<div>
    <x-admin.pages-header title="Customers" :breadcrumbs="[['label' => 'Customers', 'url' => route('admin.customer')], ['label' => 'List']]" :permission="Gate::check('customer_create')" :route="route('admin.customer', ['action' => 'create'])" />
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 relative">
                            <x-admin.action-dropdown>
                                @can('customer_show_false')
                                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600">
                                        <a href="{{ route('admin.customer', ['action' => 'show', 'id' => $user->id]) }}"
    ...
    <div class="p-4 bg-gray-100 dark:bg-gray-800 rounded-b-xl">
        {{-- {{ $users->links() }} --}}
        {{ $customers->links(data: ['scrollTo' => true]) }}
